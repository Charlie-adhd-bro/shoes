...
public partial class ShoesBdContext : DbContext
{
    public ShoesBdContext()
    {
    }

    public ShoesBdContext(DbContextOptions<ShoesBdContext> options)
        : base(options)
    {
    }
    ...
    {
        optionsBuilder.UseNpgsql("Host=localhost;Port=5432;Database=shoes_bd;Username=postgres;Password=1111");
    }
